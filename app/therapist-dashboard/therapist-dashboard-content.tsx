...
export default function TherapistDashboardContent() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [statsRes, appointmentsRes, messagesRes, patientsRes] =
          await Promise.all([
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Alert className="mb-8 border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/20">
            ...
            <AlertDescription className="text-blue-800 dark:text-blue-200">
              ...
              <p className="text-sm">
                All patient information is anonymized in this dashboard. Full
                patient details are only accessible during scheduled sessions
                  ...
                  <Card key={index}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        ...
                        <div
                          className={`${stat.color} bg-muted rounded-lg p-3`}
                        >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                appointment.date === "Today"
                                  ? handleJoinSession(appointment.id)
            ...
            <TabsContent value="patients" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Anonymous patient statistics and progress tracking
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="text-center p-4 rounded-lg border">
                      <div className="text-2xl font-bold text-green-600">
                        {patientOverview.improvementRate}%
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Improvement Rate
                      </p>
                    ...
                    <div className="text-center p-4 rounded-lg border">
                      <div className="text-2xl font-bold text-purple-600">
                        {patientOverview.avgSessionsPerPatient}
                      </div>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="mt-6">
                    <Alert>
                      ...
                      <AlertDescription>
                        Individual patient details are only accessible during
                        scheduled sessions to maintain privacy and
                        confidentiality.
                      </AlertDescription>
                    </Alert>
                  </div>
